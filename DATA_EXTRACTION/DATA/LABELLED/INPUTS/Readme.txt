(1) Nepal_Earthquake_tweetids :  This directory contains classwise tweet-ids for the Nepal Earthquake event (class name as the filename).

(2) tweetids-csv : This folder contains corresponding csv files for the tweetids.

(3) tweetids-json : This folder contains corresponding json files for the tweetids.

(4) 2015_Nepal_Earthquake_en.csv : This is another labelled file obtained from crisisNLP website.
